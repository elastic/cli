...
import type { AggregationsCardinalityAggregationShape, AggregationsCompositeAggregationShape, AggregationsRangeAggregationShape, AggregationsTermsAggregationShape, AggregationsValueCountAggregationShape } from './_types.ts'
...
export const SecurityRoleTemplateInlineQuery = z.union([z.string(), z.lazy(() => QueryDslQueryContainer)])
 ...
 */
export const SecurityIndicesPrivilegesQuery = z.union([z.string(), z.lazy(() => QueryDslQueryContainer), SecurityRoleTemplateQuery])
...
export const SecurityApiKeyType = z.enum(['rest', 'cross_cluster'])
export type SecurityApiKeyType = z.infer<typeof SecurityApiKeyType>

export const SecurityClusterPrivilege = z.union([z.enum(['all', 'cancel_task', 'create_snapshot', 'cross_cluster_replication', 'cross_cluster_search', 'delegate_pki', 'grant_api_key', 'manage', 'manage_api_key', 'manage_autoscaling', 'manage_behavioral_analytics', 'manage_ccr', 'manage_data_frame_transforms', 'manage_data_stream_global_retention', 'manage_enrich', 'manage_esql', 'manage_ilm', 'manage_index_templates', 'manage_inference', 'manage_ingest_pipelines', 'manage_logstash_pipelines', 'manage_ml', 'manage_oidc', 'manage_own_api_key', 'manage_pipeline', 'manage_rollup', 'manage_saml', 'manage_search_application', 'manage_search_query_rules', 'manage_search_synonyms', 'manage_security', 'manage_service_account', 'manage_slm', 'manage_token', 'manage_transform', 'manage_user_profile', 'manage_watcher', 'monitor', 'monitor_data_frame_transforms', 'monitor_data_stream_global_retention', 'monitor_enrich', 'monitor_esql', 'monitor_inference', 'monitor_ml', 'monitor_rollup', 'monitor_snapshot', 'monitor_stats', 'monitor_text_structure', 'monitor_transform', 'monitor_watcher', 'none', 'post_behavioral_analytics_event', 'read_ccr', 'read_fleet_secrets', 'read_ilm', 'read_pipeline', 'read_security', 'read_slm', 'transport_client', 'write_connector_secrets', 'write_fleet_secrets', 'read_project_routing', 'manage_project_routing']), z.string()])
export type SecurityClusterPrivilege = z.infer<typeof SecurityClusterPrivilege>

export const SecurityIndexPrivilege = z.union([z.enum(['all', 'auto_configure', 'create', 'create_doc', 'create_index', 'create_view', 'cross_cluster_replication', 'cross_cluster_replication_internal', 'delete', 'delete_index', 'delete_view', 'index', 'maintenance', 'manage', 'manage_data_stream_lifecycle', 'manage_follow_index', 'manage_ilm', 'manage_leader_index', 'manage_view', 'monitor', 'none', 'read', 'read_cross_cluster', 'read_view_metadata', 'view_index_metadata', 'write']), z.string()])
...
export const SecurityRemoteClusterPrivilege = z.enum(['monitor_enrich', 'monitor_stats'])
...
export const SecurityRestrictionWorkflow = z.union([z.enum(['search_application_query']), z.string()])
...
export const SecurityApiKeyManagedBy = z.enum(['cloud', 'elasticsearch'])
...
export const SecurityGrantType = z.enum(['password', 'access_token'])
...
export const SecurityTemplateFormat = z.enum(['string', 'json'])
...
export const SecurityRoleMappingRule: z.ZodType<SecurityRoleMappingRuleShape> = SecurityRoleMappingRuleExclusiveProps
...
export const SecurityUserProfileId = z.string()
...
export const SecurityActivateUserProfileResponse = SecurityUserProfileWithMetadata
...
export const SecurityDeletePrivilegesResponse = z.record(z.string(), z.record(z.string(), SecurityDeletePrivilegesFoundStatus))
...
export const SecurityDisableUserProfileResponse = z.lazy(() => AcknowledgedResponseBase)
...
export const SecurityEnableUserProfileResponse = z.lazy(() => AcknowledgedResponseBase)
...
export const SecurityGetPrivilegesResponse = z.record(z.string(), z.record(z.string(), SecurityPutPrivilegesActions))
...
export const SecurityGetRoleResponse = z.record(z.string(), SecurityGetRoleRole)
...
export const SecurityGetRoleMappingResponse = z.record(z.string(), SecurityRoleMapping)
...
export const SecurityGetServiceAccountsResponse = z.record(z.string(), SecurityGetServiceAccountsRoleDescriptorWrapper)
...
export const SecurityGetTokenAccessTokenGrantType = z.enum(['password', 'client_credentials', '_kerberos', 'refresh_token'])
...
export const SecurityGetUserResponse = z.record(z.string(), SecurityUser)
...
export const SecurityGrantApiKeyApiKeyGrantType = z.enum(['access_token', 'password'])
...
export const SecurityHasPrivilegesPrivileges = z.record(z.string(), z.boolean())
export type SecurityHasPrivilegesPrivileges = z.infer<typeof SecurityHasPrivilegesPrivileges>

export const SecurityHasPrivilegesResourcePrivileges = z.record(z.lazy(() => Name), SecurityHasPrivilegesPrivileges)
export type SecurityHasPrivilegesResourcePrivileges = z.infer<typeof SecurityHasPrivilegesResourcePrivileges>

export const SecurityHasPrivilegesApplicationsPrivileges = z.record(z.lazy(() => Name), SecurityHasPrivilegesResourcePrivileges)
...
export const SecurityPutPrivilegesResponse = z.record(z.string(), z.record(z.string(), SecurityCreatedStatus))
...
export const SecurityQueryApiKeysApiKeyQueryContainer = SecurityQueryApiKeysApiKeyQueryContainerExclusiveProps
...
export const SecurityQueryApiKeysApiKeyAggregationContainer: z.ZodType<SecurityQueryApiKeysApiKeyAggregationContainerShape> = SecurityQueryApiKeysApiKeyAggregationContainerCommonProps.and(SecurityQueryApiKeysApiKeyAggregationContainerExclusiveProps)
...
export const SecurityQueryRoleRoleQueryContainer = SecurityQueryRoleRoleQueryContainerExclusiveProps
...
export const SecurityQueryUserUserQueryContainer = SecurityQueryUserUserQueryContainerExclusiveProps
...
export const SecuritySamlCompleteLogoutResponse = z.boolean()
...
export const SecurityUpdateUserProfileDataResponse = z.lazy(() => AcknowledgedResponseBase)
