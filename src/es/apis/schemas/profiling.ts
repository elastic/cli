...
export const ProfilingFlamegraphResponse = z.any()
...
export const ProfilingStacktracesResponse = z.any()
export type ProfilingStacktracesResponse = z.infer<typeof ProfilingStacktracesResponse>

export const ProfilingStatusProfilingOperationMode = z.enum(['RUNNING', 'STOPPING', 'STOPPED'])
...
export const ProfilingTopnFunctionsResponse = z.any()
