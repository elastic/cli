...
export const SnapshotRepository = z.union([SnapshotAzureRepository, SnapshotGcsRepository, SnapshotS3Repository, SnapshotSharedFileSystemRepository, SnapshotReadOnlyUrlRepository, SnapshotSourceOnlyRepository])
...
export const SnapshotShardsStatsStage = z.enum(['DONE', 'FAILURE', 'FINALIZE', 'INIT', 'STARTED'])
...
export const SnapshotSnapshotSort = z.enum(['start_time', 'duration', 'name', 'index_count', 'repository', 'shard_count', 'failed_shard_count'])
export type SnapshotSnapshotSort = z.infer<typeof SnapshotSnapshotSort>

export const SnapshotSnapshotState = z.enum(['IN_PROGRESS', 'SUCCESS', 'FAILED', 'PARTIAL', 'INCOMPATIBLE'])
...
export const SnapshotCloneResponse = z.lazy(() => AcknowledgedResponseBase)
...
export const SnapshotCreateRepositoryResponse = z.lazy(() => AcknowledgedResponseBase)
...
export const SnapshotDeleteResponse = z.lazy(() => AcknowledgedResponseBase)
...
export const SnapshotDeleteRepositoryResponse = z.lazy(() => AcknowledgedResponseBase)
...
export const SnapshotGetRepositoryResponse = z.record(z.string(), SnapshotRepository)
...
export const SnapshotRepositoryVerifyIntegrityResponse = z.any()
