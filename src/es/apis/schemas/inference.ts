...
export const InferenceAi21ServiceType = z.enum(['ai21'])
export type InferenceAi21ServiceType = z.infer<typeof InferenceAi21ServiceType>

export const InferenceAi21TaskType = z.enum(['completion', 'chat_completion'])
...
export const InferenceAlibabaCloudServiceType = z.enum(['alibabacloud-ai-search'])
...
export const InferenceAlibabaCloudTaskType = z.enum(['completion', 'rerank', 'sparse_embedding', 'text_embedding'])
...
export const InferenceAmazonBedrockServiceType = z.enum(['amazonbedrock'])
...
export const InferenceAmazonBedrockTaskType = z.enum(['chat_completion', 'completion', 'text_embedding'])
export type InferenceAmazonBedrockTaskType = z.infer<typeof InferenceAmazonBedrockTaskType>

export const InferenceAmazonSageMakerApi = z.enum(['openai', 'elastic'])
...
export const InferenceAmazonSageMakerServiceType = z.enum(['amazon_sagemaker'])
...
export const InferenceAnthropicServiceType = z.enum(['anthropic'])
...
export const InferenceAnthropicTaskType = z.enum(['completion'])
...
export const InferenceAzureAiStudioServiceType = z.enum(['azureaistudio'])
...
export const InferenceAzureAiStudioTaskType = z.enum(['completion', 'rerank', 'text_embedding'])
...
export const InferenceAzureOpenAIServiceType = z.enum(['azureopenai'])
...
export const InferenceAzureOpenAITaskType = z.enum(['completion', 'chat_completion', 'text_embedding'])
...
export const InferenceCohereEmbeddingType = z.enum(['binary', 'bit', 'byte', 'float', 'int8'])
export type InferenceCohereEmbeddingType = z.infer<typeof InferenceCohereEmbeddingType>

export const InferenceCohereInputType = z.enum(['classification', 'clustering', 'ingest', 'search'])
export type InferenceCohereInputType = z.infer<typeof InferenceCohereInputType>

export const InferenceCohereSimilarityType = z.enum(['cosine', 'dot_product', 'l2_norm'])
...
export const InferenceCohereServiceType = z.enum(['cohere'])
export type InferenceCohereServiceType = z.infer<typeof InferenceCohereServiceType>

export const InferenceCohereTruncateType = z.enum(['END', 'NONE', 'START'])
...
export const InferenceCohereTaskType = z.enum(['completion', 'rerank', 'text_embedding'])
...
export const InferenceCompletionToolType = z.union([z.string(), InferenceCompletionToolChoice])
export type InferenceCompletionToolType = z.infer<typeof InferenceCompletionToolType>

export const InferenceContentType = z.enum(['text', 'image_url', 'file'])
export type InferenceContentType = z.infer<typeof InferenceContentType>

export const InferenceImageUrlDetail = z.enum(['auto', 'low', 'high'])
...
export const InferenceContextualAIServiceType = z.enum(['contextualai'])
...
export const InferenceCustomServiceInputType = z.enum(['classification', 'clustering', 'ingest', 'search'])
export type InferenceCustomServiceInputType = z.infer<typeof InferenceCustomServiceInputType>

export const InferenceCustomServiceQueryParameter = z.array(z.string())
...
export const InferenceCustomServiceType = z.enum(['custom'])
export type InferenceCustomServiceType = z.infer<typeof InferenceCustomServiceType>

export const InferenceCustomTaskParameter = z.union([z.string(), z.lazy(() => integer), z.lazy(() => double), z.lazy(() => float), z.boolean()])
...
export const InferenceCustomTaskType = z.enum(['text_embedding', 'sparse_embedding', 'rerank', 'completion'])
...
export const InferenceDeepSeekServiceType = z.enum(['deepseek'])
 ...
 * Vectors of bytes.
 */
export const InferenceDenseByteVector = z.array(byte)
 ...
 * of floats.
 */
export const InferenceDenseVector = z.array(z.lazy(() => float))
...
export const InferenceElasticsearchServiceType = z.enum(['elasticsearch'])
...
export const InferenceElasticsearchTaskType = z.enum(['rerank', 'sparse_embedding', 'text_embedding'])
...
export const InferenceEmbeddingContentInput = z.union([InferenceEmbeddingContentObject, z.array(InferenceEmbeddingContentObject)])
...
export const InferenceEmbeddingInferenceResult = InferenceEmbeddingInferenceResultExclusiveProps
...
export const InferenceEmbeddingStringInput = z.union([z.string(), z.array(z.string())])
 ...
 */
export const InferenceEmbeddingInput = z.union([InferenceEmbeddingStringInput, InferenceEmbeddingContentInput])
...
export const InferenceFireworksAISimilarityType = z.enum(['cosine', 'dot_product', 'l2_norm'])
...
export const InferenceFireworksAIServiceType = z.enum(['fireworksai'])
...
export const InferenceFireworksAITaskType = z.enum(['chat_completion', 'completion', 'text_embedding'])
export type InferenceFireworksAITaskType = z.infer<typeof InferenceFireworksAITaskType>

export const InferenceGoogleAiServiceType = z.enum(['googleaistudio'])
...
export const InferenceGoogleAiStudioTaskType = z.enum(['completion', 'text_embedding'])
export type InferenceGoogleAiStudioTaskType = z.infer<typeof InferenceGoogleAiStudioTaskType>

export const InferenceGoogleModelGardenProvider = z.enum(['google', 'anthropic', 'meta', 'hugging_face', 'mistral', 'ai21'])
...
export const InferenceGoogleVertexAIServiceType = z.enum(['googlevertexai'])
...
export const InferenceGoogleVertexAITaskType = z.enum(['rerank', 'text_embedding', 'completion', 'chat_completion'])
...
export const InferenceGroqServiceType = z.enum(['groq'])
export type InferenceGroqServiceType = z.infer<typeof InferenceGroqServiceType>

export const InferenceGroqTaskType = z.enum(['chat_completion'])
...
export const InferenceHuggingFaceServiceType = z.enum(['hugging_face'])
...
export const InferenceHuggingFaceTaskType = z.enum(['chat_completion', 'completion', 'rerank', 'text_embedding'])
...
export const InferenceServiceSettings = z.any()
export type InferenceServiceSettings = z.infer<typeof InferenceServiceSettings>

export const InferenceTaskSettings = z.any()
...
export const InferenceTaskType = z.enum(['sparse_embedding', 'text_embedding', 'rerank', 'completion', 'chat_completion', 'embedding'])
...
export const InferenceTaskTypeAi21 = z.enum(['completion', 'chat_completion'])
...
export const InferenceTaskTypeAlibabaCloudAI = z.enum(['text_embedding', 'rerank', 'completion', 'sparse_embedding'])
...
export const InferenceTaskTypeAmazonBedrock = z.enum(['chat_completion', 'completion', 'text_embedding'])
...
export const InferenceTaskTypeAmazonSageMaker = z.enum(['text_embedding', 'completion', 'chat_completion', 'sparse_embedding', 'rerank'])
...
export const InferenceTaskTypeAnthropic = z.enum(['completion'])
...
export const InferenceTaskTypeAzureAIStudio = z.enum(['text_embedding', 'completion', 'rerank'])
...
export const InferenceTaskTypeAzureOpenAI = z.enum(['text_embedding', 'completion', 'chat_completion'])
...
export const InferenceTaskTypeCohere = z.enum(['text_embedding', 'rerank', 'completion'])
...
export const InferenceTaskTypeContextualAI = z.enum(['rerank'])
...
export const InferenceTaskTypeCustom = z.enum(['text_embedding', 'sparse_embedding', 'rerank', 'completion'])
...
export const InferenceTaskTypeDeepSeek = z.enum(['completion', 'chat_completion'])
...
export const InferenceTaskTypeELSER = z.enum(['sparse_embedding'])
...
export const InferenceTaskTypeElasticsearch = z.enum(['sparse_embedding', 'text_embedding', 'rerank'])
...
export const InferenceTaskTypeFireworksAI = z.enum(['chat_completion', 'completion', 'text_embedding'])
...
export const InferenceTaskTypeGoogleAIStudio = z.enum(['text_embedding', 'completion'])
...
export const InferenceTaskTypeGoogleVertexAI = z.enum(['chat_completion', 'completion', 'text_embedding', 'rerank'])
...
export const InferenceTaskTypeGroq = z.enum(['chat_completion'])
...
export const InferenceTaskTypeHuggingFace = z.enum(['chat_completion', 'completion', 'rerank', 'text_embedding'])
...
export const InferenceTaskTypeJinaAi = z.enum(['embedding', 'text_embedding', 'rerank'])
...
export const InferenceTaskTypeLlama = z.enum(['text_embedding', 'chat_completion', 'completion'])
...
export const InferenceTaskTypeMistral = z.enum(['text_embedding', 'chat_completion', 'completion'])
...
export const InferenceTaskTypeNvidia = z.enum(['chat_completion', 'completion', 'rerank', 'text_embedding'])
...
export const InferenceTaskTypeOpenAI = z.enum(['text_embedding', 'chat_completion', 'completion'])
...
export const InferenceTaskTypeOpenShiftAi = z.enum(['text_embedding', 'chat_completion', 'completion', 'rerank'])
...
export const InferenceTaskTypeVoyageAI = z.enum(['text_embedding', 'rerank'])
...
export const InferenceTaskTypeWatsonx = z.enum(['text_embedding', 'chat_completion', 'completion'])
 ...
 * of string to double.
 */
export const InferenceSparseVector = z.record(z.string(), z.lazy(() => float))
...
export const InferenceInferenceResult = InferenceInferenceResultExclusiveProps
export type InferenceInferenceResult = z.infer<typeof InferenceInferenceResult>

export const InferenceJinaAIElementType = z.enum(['binary', 'bit', 'float'])
export type InferenceJinaAIElementType = z.infer<typeof InferenceJinaAIElementType>

export const InferenceJinaAISimilarityType = z.enum(['cosine', 'dot_product', 'l2_norm'])
...
export const InferenceJinaAIServiceType = z.enum(['jinaai'])
export type InferenceJinaAIServiceType = z.infer<typeof InferenceJinaAIServiceType>

export const InferenceJinaAITextEmbeddingTask = z.enum(['classification', 'clustering', 'ingest', 'search'])
...
export const InferenceJinaAITaskType = z.enum(['embedding', 'rerank', 'text_embedding'])
export type InferenceJinaAITaskType = z.infer<typeof InferenceJinaAITaskType>

export const InferenceLlamaSimilarityType = z.enum(['cosine', 'dot_product', 'l2_norm'])
...
export const InferenceLlamaServiceType = z.enum(['llama'])
export type InferenceLlamaServiceType = z.infer<typeof InferenceLlamaServiceType>

export const InferenceLlamaTaskType = z.enum(['text_embedding', 'completion', 'chat_completion'])
export type InferenceLlamaTaskType = z.infer<typeof InferenceLlamaTaskType>

export const InferenceMessageContent = z.union([z.string(), z.array(InferenceContentObject)])
 ...
 */
export const InferenceReasoningDetail = z.union([InferenceEncryptedReasoningDetail, InferenceSummaryReasoningDetail, InferenceTextReasoningDetail])
...
export const InferenceMistralServiceType = z.enum(['mistral'])
export type InferenceMistralServiceType = z.infer<typeof InferenceMistralServiceType>

export const InferenceMistralTaskType = z.enum(['text_embedding', 'completion', 'chat_completion'])
export type InferenceMistralTaskType = z.infer<typeof InferenceMistralTaskType>

export const InferenceNvidiaInputType = z.enum(['ingest', 'search'])
export type InferenceNvidiaInputType = z.infer<typeof InferenceNvidiaInputType>

export const InferenceNvidiaSimilarityType = z.enum(['cosine', 'dot_product', 'l2_norm'])
...
export const InferenceNvidiaServiceType = z.enum(['nvidia'])
...
export const InferenceNvidiaTaskType = z.enum(['chat_completion', 'completion', 'rerank', 'text_embedding'])
export type InferenceNvidiaTaskType = z.infer<typeof InferenceNvidiaTaskType>

export const InferenceOpenAISimilarityType = z.enum(['cosine', 'dot_product', 'l2_norm'])
...
export const InferenceOpenAIServiceType = z.enum(['openai'])
...
export const InferenceOpenAITaskType = z.enum(['chat_completion', 'completion', 'text_embedding'])
export type InferenceOpenAITaskType = z.infer<typeof InferenceOpenAITaskType>

export const InferenceOpenShiftAiSimilarityType = z.enum(['cosine', 'dot_product', 'l2_norm'])
...
export const InferenceOpenShiftAiServiceType = z.enum(['openshift_ai'])
...
export const InferenceOpenShiftAiTaskType = z.enum(['text_embedding', 'completion', 'chat_completion', 'rerank'])
export type InferenceOpenShiftAiTaskType = z.infer<typeof InferenceOpenShiftAiTaskType>

export const InferenceReasoningEffort = z.enum(['xhigh', 'high', 'medium', 'low', 'minimal', 'none'])
export type InferenceReasoningEffort = z.infer<typeof InferenceReasoningEffort>

export const InferenceReasoningSummary = z.enum(['auto', 'concise', 'detailed'])
...
export const InferenceTextEmbeddingInferenceResult = InferenceTextEmbeddingInferenceResultExclusiveProps
...
export const InferenceVoyageAIServiceType = z.enum(['voyageai'])
...
export const InferenceVoyageAITaskType = z.enum(['text_embedding', 'rerank'])
...
export const InferenceWatsonxServiceType = z.enum(['watsonxai'])
export type InferenceWatsonxServiceType = z.infer<typeof InferenceWatsonxServiceType>

export const InferenceWatsonxTaskType = z.enum(['text_embedding', 'rerank', 'chat_completion', 'completion'])
...
export const InferenceChatCompletionUnifiedResponse = StreamResult
...
export const InferenceCompletionResponse = InferenceCompletionInferenceResult
...
export const InferenceDeleteResponse = InferenceDeleteInferenceEndpointResult
...
export const InferenceEmbeddingResponse = InferenceEmbeddingInferenceResult
...
export const InferenceInferenceResponse = InferenceInferenceResult
...
export const InferencePutResponse = InferenceInferenceEndpointInfo
...
export const InferencePutAi21Response = InferenceInferenceEndpointInfoAi21
...
export const InferencePutAlibabacloudResponse = InferenceInferenceEndpointInfoAlibabaCloudAI
...
export const InferencePutAmazonbedrockResponse = InferenceInferenceEndpointInfoAmazonBedrock
...
export const InferencePutAmazonsagemakerResponse = InferenceInferenceEndpointInfoAmazonSageMaker
...
export const InferencePutAnthropicResponse = InferenceInferenceEndpointInfoAnthropic
...
export const InferencePutAzureaistudioResponse = InferenceInferenceEndpointInfoAzureAIStudio
...
export const InferencePutAzureopenaiResponse = InferenceInferenceEndpointInfoAzureOpenAI
...
export const InferencePutCohereResponse = InferenceInferenceEndpointInfoCohere
...
export const InferencePutContextualaiResponse = InferenceInferenceEndpointInfoContextualAi
...
export const InferencePutCustomResponse = InferenceInferenceEndpointInfoCustom
...
export const InferencePutDeepseekResponse = InferenceInferenceEndpointInfoDeepSeek
...
export const InferencePutElasticsearchResponse = InferenceInferenceEndpointInfoElasticsearch
...
export const InferencePutElserResponse = InferenceInferenceEndpointInfoELSER
...
export const InferencePutFireworksaiResponse = InferenceInferenceEndpointInfoFireworksAI
...
export const InferencePutGoogleaistudioResponse = InferenceInferenceEndpointInfoGoogleAIStudio
...
export const InferencePutGooglevertexaiResponse = InferenceInferenceEndpointInfoGoogleVertexAI
...
export const InferencePutGroqResponse = InferenceInferenceEndpointInfoGroq
...
export const InferencePutHuggingFaceResponse = InferenceInferenceEndpointInfoHuggingFace
...
export const InferencePutJinaaiResponse = InferenceInferenceEndpointInfoJinaAi
...
export const InferencePutLlamaResponse = InferenceInferenceEndpointInfoLlama
...
export const InferencePutMistralResponse = InferenceInferenceEndpointInfoMistral
...
export const InferencePutNvidiaResponse = InferenceInferenceEndpointInfoNvidia
...
export const InferencePutOpenaiResponse = InferenceInferenceEndpointInfoOpenAI
...
export const InferencePutOpenshiftAiResponse = InferenceInferenceEndpointInfoOpenShiftAi
...
export const InferencePutVoyageaiResponse = InferenceInferenceEndpointInfoVoyageAI
...
export const InferencePutWatsonxResponse = InferenceInferenceEndpointInfoWatsonx
...
export const InferenceRerankResponse = InferenceRerankedInferenceResult
...
export const InferenceSparseEmbeddingResponse = InferenceSparseEmbeddingInferenceResult
...
export const InferenceStreamCompletionResponse = StreamResult
...
export const InferenceTextEmbeddingResponse = InferenceTextEmbeddingInferenceResult
...
export const InferenceUpdateResponse = InferenceInferenceEndpointInfo
