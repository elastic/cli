...
export const IngestShapeType = z.enum(['geo_shape', 'shape'])
export type IngestShapeType = z.infer<typeof IngestShapeType>

export const IngestConvertType = z.enum(['integer', 'long', 'double', 'float', 'boolean', 'ip', 'string', 'auto'])
export type IngestConvertType = z.infer<typeof IngestConvertType>

export const IngestFingerprintDigest = z.enum(['MD5', 'SHA-1', 'SHA-256', 'SHA-512', 'MurmurHash3'])
export type IngestFingerprintDigest = z.infer<typeof IngestFingerprintDigest>

export const IngestGeoGridTileType = z.enum(['geotile', 'geohex', 'geohash'])
export type IngestGeoGridTileType = z.infer<typeof IngestGeoGridTileType>

export const IngestGeoGridTargetFormat = z.enum(['geojson', 'wkt'])
...
export const IngestInferenceConfig = IngestInferenceConfigExclusiveProps
...
export const IngestJsonProcessorConflictStrategy = z.enum(['replace', 'merge'])
export type IngestJsonProcessorConflictStrategy = z.infer<typeof IngestJsonProcessorConflictStrategy>

export const IngestUserAgentProperty = z.enum(['name', 'os', 'device', 'original', 'version'])
...
export const IngestProcessorContainer: z.ZodType<IngestProcessorContainerShape> = IngestProcessorContainerExclusiveProps
 ...
 */
export const IngestDatabaseConfiguration = IngestDatabaseConfigurationCommonProps.and(IngestDatabaseConfigurationExclusiveProps)
...
export const IngestDatabaseConfigurationFull = IngestDatabaseConfigurationFullCommonProps.and(IngestDatabaseConfigurationFullExclusiveProps)
...
export const IngestFieldAccessPattern = z.enum(['classic', 'flexible'])
...
export const IngestPipelineSimulationStatusOptions = z.enum(['success', 'error', 'error_ignored', 'skipped', 'dropped'])
...
export const IngestDeleteGeoipDatabaseResponse = z.lazy(() => AcknowledgedResponseBase)
...
export const IngestDeleteIpLocationDatabaseResponse = z.lazy(() => AcknowledgedResponseBase)
...
export const IngestDeletePipelineResponse = z.lazy(() => AcknowledgedResponseBase)
...
export const IngestGetPipelineResponse = z.record(z.string(), IngestPipeline)
...
export const IngestPutGeoipDatabaseResponse = z.lazy(() => AcknowledgedResponseBase)
...
export const IngestPutIpLocationDatabaseResponse = z.lazy(() => AcknowledgedResponseBase)
...
export const IngestPutPipelineResponse = z.lazy(() => AcknowledgedResponseBase)
