...
import { AcknowledgedResponseBase, Duration, DurationValue, ErrorCause, FieldValue, Id, IndexName, NodeId, ProjectRouting, QueryDslQueryContainer, TaskId, double, integer, long } from './_types.ts'
...
export const EsqlEsqlClusterStatus = z.enum(['running', 'successful', 'partial', 'skipped', 'failed'])
...
export const EsqlSingleOrMultiValue = z.union([z.lazy(() => FieldValue), z.array(z.lazy(() => FieldValue))])
export type EsqlSingleOrMultiValue = z.infer<typeof EsqlSingleOrMultiValue>

export const EsqlNamedValue = z.record(z.string(), EsqlSingleOrMultiValue)
export type EsqlNamedValue = z.infer<typeof EsqlNamedValue>

export const EsqlESQLParams = z.union([z.array(EsqlSingleOrMultiValue), z.array(EsqlNamedValue)])
...
export const EsqlEsqlFormat = z.enum(['csv', 'json', 'tsv', 'txt', 'yaml', 'cbor', 'smile', 'arrow'])
export type EsqlEsqlFormat = z.infer<typeof EsqlEsqlFormat>

export const EsqlTableValuesIntegerValue = z.union([z.lazy(() => integer), z.array(z.lazy(() => integer))])
export type EsqlTableValuesIntegerValue = z.infer<typeof EsqlTableValuesIntegerValue>

export const EsqlTableValuesKeywordValue = z.union([z.string(), z.array(z.string())])
export type EsqlTableValuesKeywordValue = z.infer<typeof EsqlTableValuesKeywordValue>

export const EsqlTableValuesLongValue = z.union([z.lazy(() => long), z.array(z.lazy(() => long))])
export type EsqlTableValuesLongValue = z.infer<typeof EsqlTableValuesLongValue>

export const EsqlTableValuesLongDouble = z.union([z.lazy(() => double), z.array(z.lazy(() => double))])
...
export const EsqlTableValuesContainer = EsqlTableValuesContainerExclusiveProps
...
export const EsqlAsyncQueryResponse = EsqlAsyncEsqlResult
...
export const EsqlAsyncQueryDeleteResponse = z.lazy(() => AcknowledgedResponseBase)
...
export const EsqlAsyncQueryGetResponse = EsqlAsyncEsqlResult
...
export const EsqlAsyncQueryStopResponse = EsqlEsqlResult
...
export const EsqlDeleteViewResponse = z.lazy(() => AcknowledgedResponseBase)
...
export const EsqlPutViewResponse = z.lazy(() => AcknowledgedResponseBase)
...
export const EsqlQueryResponse = EsqlEsqlResult
